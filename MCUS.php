...
$product = $database->query("SELECT * FROM products  WHERE product_num = '23'");
...
if(isset($_POST['addfav'])){
  if(isset($_SESSION['user_id'])){
    ...
    $check_wishlist_numbers = $database->prepare("SELECT * FROM wishlist WHERE product_num = '23' AND user_id = '$user_id' ");
      ...
      foreach ($rows as $row)  {
        ...
        $adddata = $database->prepare("INSERT INTO wishlist (user_id,product_num,product_name,product_img,price) VALUES( '$user_id' ,'23','$product_name','$product_img','$price')");
        $adddata->execute();
...
<head>
    ...
    <title>Microcontrollers (MCUs)</title>
          ...
          <div class = "product-div">
              ...
              <div class = "product-div-right">
                  ...
                  <video controls width="350">
                      <source src="https://youtu.be/PFbPXrs-5Ok"type="video/webm">
