...
$product = $database->query("SELECT * FROM products  WHERE product_num = '14'");
...
if(isset($_POST['addfav'])){
  if(isset($_SESSION['user_id'])){
    ...
    $check_wishlist_numbers = $database->prepare("SELECT * FROM wishlist WHERE product_num = '14' AND user_id = '$user_id' ");
      ...
      foreach ($rows as $row)  {
        ...
        $adddata = $database->prepare("INSERT INTO wishlist (user_id,product_num,product_name,product_img,price) VALUES( '$user_id' ,'14','$product_name','$product_img','$price')");
        $adddata->execute();
               ...
               <ul class="navbar-nav">
                ...
                <div class="icon-conect d-flex justify-content-center align-items-center">
                  ...
                  <i class="fa-solid fa-cart-shopping "></i><span><?= $total_cart_counts; ?></span>
                    ...
                    <button class=" mx-1 btn  border-0 "><a href="search.phph">
