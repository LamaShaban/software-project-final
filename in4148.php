...
$product = $database->query("SELECT * FROM products  WHERE product_num = '11'");
...
if(isset($_POST['addfav'])){
    ...
    $check_wishlist_numbers = $database->prepare("SELECT * FROM wishlist WHERE product_num = '11' AND user_id = '$user_id' ");
      ...
      foreach ($rows as $row)  {
        ...
        $adddata = $database->prepare("INSERT INTO wishlist (user_id,product_num,product_name,product_img,price) VALUES( '$user_id' ,'11','$product_name','$product_img','$price')");
        $adddata->execute();
...
<body>
    ...
    <ul>
      ...
      <li><a href="rating.php"><i class="fa-solid fa-gear "></i>Rate this Shop</a></li>
