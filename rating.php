...
if(isset($_POST['submit'])){
  ...
  $adddata = $database->prepare("INSERT INTO usersrate(user_id,name,rate) VALUES( '$user_id' ,'$username','$rate')");
...
<div class="list">
    ...
    <div class="rate-box p-4" style="background-color: #ffcc0073; border-radius: 5px;">
        <form action="#" method="POST">
            <div class="textarea">
                <textarea cols="30" placeholder="Describe your experience.." name="rate"></textarea>
