...
$all_products = $database->query("SELECT * FROM products  WHERE product_num = '28'");
...
<head>
    ...
    <title>Electromechanical Buzzer</title>
          ...
          <div class = "product-div">
              ...
              <div class = "product-div-right">
                  ...
                  <div class = "btn-groups">
                      <button type = "button" class = "add-cart-btn" onclick="addToCard(<?php echo $row['product_num']-1; ?>)"><i class = "fas fa-shopping-cart"></i>add to cart</button>
                      <button type = "button" class = "add-wishlist-btn"><i class = "fas fa-wallet"></i>add to wishlist</button>
                  </div>
              </div>
          </div>
        <?php
