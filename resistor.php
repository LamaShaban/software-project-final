...
$all_products = $database->query("SELECT * FROM products  WHERE category = ' Resistor'");
...
<html lang="en">
 ...
 <div class="wrapper">
    <div class="container">
      <h1 style="margin-top:100px">Resistors</h1>
    <div id="products">
    <?php
            foreach ($rows as $row) {
          ?>
         <div class="card">
            ...
            <div class="contain">
                <a href="<?php echo $row['product_page']; ?>" class="product-name" >
                ...
                <form action="" method="Post">
                              ...
                              <button type="submit" value="add to cart" class="add-to-cart" name="add_to_cart"><i class = "fas fa-cart-shopping"></i>add to Cart</button>
