...
$product = $database->query("SELECT * FROM products  WHERE product_num = '19'");
...
if(isset($_POST['addfav'])){
  if(isset($_SESSION['user_id'])){
    ...
    $check_wishlist_numbers = $database->prepare("SELECT * FROM wishlist WHERE product_num = '19' AND user_id = '$user_id' ");
      ...
      foreach ($rows as $row)  {
        ...
        $adddata = $database->prepare("INSERT INTO wishlist (user_id,product_num,product_name,product_img,price) VALUES( '$user_id' ,'19','$product_name','$product_img','$price')");
        $adddata->execute();
    ...
    <header class="header">
               ...
               <ul class="navbar-nav">
                ...
                <div class="icon-conect d-flex justify-content-center align-items-center">
                  <button class=" mx-1 btn border-0 shopping "><i class="fa-solid fa-cart-shopping "></i><span class="quantity">0</span></button>
                    <button class=" mx-1 btn  border-0 "><a href="whishlist.html"><i class="fa-solid fa-heart"></i></a>
                    </button>
                    <button class=" mx-1 btn  border-0 "><a href="search.html"><i class="fa-solid fa-magnifying-glass "></i></a></button>
	 ...
	 <div class="sidebars">
      ...
      <div class="user">
		...
		<ul>
			<li><a href="whishlist.html"><i class="fa-solid fa-heart "></i>Whishlist</a></li>
			<li><a href="#"><i class="fa-solid fa-heart "></i>MY Cart</a></li>
			<li><a href="myOrders.html"><i class="fa-solid fa-heart "></i>Orders</a></li>
			<li><a href="settings.html"><i class="fa-solid fa-heart "></i>Settings</a></li>
      <li><a href="rating.html"><i class="fa-solid fa-star"></i>Rate this shop</a></li>
			<li><a href="index.html"><i class="fa-solid fa-heart "></i>Logout</a></li>
		</ul>
    <?php
       }
    ?>
